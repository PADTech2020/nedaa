...
class PostForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('breaking_news', 'onOff', [
                'label' => trans('core/base::forms.breaking_news'),
                'label_attr' => ['class' => 'control-label'],
                'default_value' => false,
            ])
            ->add('trending', 'onOff', [
            ...
            ->add('news_tape', 'onOff', [
                'label' => trans('core/base::forms.news_tape'),
                'label_attr' => ['class' => 'control-label'],
                'default_value' => false,
            ])
            ->add('slider_order', 'number', [
                'label' => __('Slider Order'),
                'label_attr' => ['class' => 'control-label'],
                'attr' => [
                    'class' => 'form-control ',
                ],
            ...
            ->add('youtube_link', 'text', [
                ...
                'default_value' => 'https://youtu.be/',
            ])
            ->add('pdf_file', 'mediaImage', [
                'label' => trans('PDF File'),
                'label_attr' => ['class' => 'control-label pdf-file'],
            ])
