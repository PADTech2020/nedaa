...
use Botble\Base\Enums\SliderStatusEnum;
...
class PostTable extends TableAbstract
{
    ...
    public function ajax()
    {
        $data = $this->table
            ...
            ->editColumn('short_link', function ($item) {

                if ($item->short_link!='')
                    return '<a target="_blank"  href="/article/' . $item->short_link.'">'.$item->short_link.'</a>' ;
                else return 'No';
            })
    ...
    public function columns()
    {
        return [
            ...
            'short_link' => [
                'name' => 'posts.short_link',
                'title' => trans('Short link'),
                'class' => 'text-left',
            ],

            'slider_order' => [
                'name' => 'posts.slider_order',
                'title' => trans('Slider Order'),
                'class' => 'text-left',
            ],
    ...
    public function getBulkChanges(): array
    {
        return [
            ...
            'posts.is_slider' => [
                'title' => trans('core/base::tables.is_slider'),
                'type' => 'text',
                'validate' => 'required',
            ],
            'posts.breaking_news' => [
                'title' => trans('core/base::tables.breaking_news'),
                'type' => 'text',
                'validate' => 'required',
            ],
            'posts.author_id' => [
                'title' => trans('core/base::tables.author_name'),
                'type' => 'select-search',
                'validate' => 'required',
                'callback' => 'getAuthors',
            ],
            'posts.news_tape' => [
                'title' => trans('core/base::tables.news_tape'),
                'type' => 'text',
                'validate' => 'required',
            ],
        ];
